...
function showPaymentReceiptModal(data) {
  ...
  modal.innerHTML = `
    <div class="product-modal-box" style="max-width: 500px; padding: 24px; position:relative;">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius-sm);overflow:hidden;background:#f1f5f9;display:flex;justify-content:center;align-items:center;padding:6px;">
      ...
      <div style="display:grid;grid-template-columns:1.2fr 0.8fr;gap:12px;margin-top:16px;">
        ...
        <button class="btn btn-secondary" onclick="closeReceiptModal()" style="background:rgba(0,0,0,0.04);border:1px solid var(--border);color:var(--text-primary);">
          Close
        </button>
      </div>
    </div>
